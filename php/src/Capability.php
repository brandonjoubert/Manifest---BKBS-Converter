...
/**
 * Stage 9 capability layer. Callers pass the public resolve set only.
 * Does not write knowledge files.
 */
final class Capability
{
    ...
    public static function enabled(array $site): bool
    {
        return (int) ($site['capability_enabled'] ?? 0) === 1;
    }
